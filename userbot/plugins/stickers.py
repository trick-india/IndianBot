...
from userbot import ALIVE_NAME, CUSTOM_STICKER_PACK_NAME, CUSTOM_ANIMATED_STICKER_PACK_NAME
...
async def _(event):
    ...
    if Var.CUSTOM_STICKER_PACK_NAME is not None:
    ...
    if is_a_s:
        ...
        if Var.CUSTOM_ANIMATED_STICKER_PACK_NAME is not None:
